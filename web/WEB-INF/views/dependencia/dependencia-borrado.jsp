...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="public/css/dependencia/dependencia-borrado.css" /> 
    </head>
    ...
    <body>
        ...
        <!-- Application Scripts -->
        <script src="public/js/dependencia/dependencia-borrado.js"></script>
