    ...
    <body>
        ...
        <div id="container">
            ...
            <main>
                ...
                <header>
                    <h2>Borrado de Notificaciones</h2>
                ...
                <nav class="controles">
                    <a class="btn btn-borrar" href="?cmd=notificacion-borrado&op=proceso&id=<%= notificacion.getId()%>">Borrar</a>
                </nav>
            </main>
        ...
        <!-- Application Scripts -->
        <script src="public/js/notificacion/notificacion-borrado.js"></script>
